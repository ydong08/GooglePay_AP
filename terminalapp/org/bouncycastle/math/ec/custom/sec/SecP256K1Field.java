...
public class SecP256K1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat256.mul33DWordAdd(977, Nat256.mul33Add(977, iArr, 8, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, P))) {
            Nat.add33To(8, 977, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i != 0 && Nat256.mul33WordAdd(977, i, iArr, 0) != 0) || (iArr[7] == -1 && Nat256.gte(iArr, P))) {
