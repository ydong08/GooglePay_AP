...
public class ViewPager extends ViewGroup {
    ...
    L_0x005b:
        r2 = r17.getResources();	 Catch:{ NotFoundException -> 0x00b8 }
        r3 = r17.getId();	 Catch:{ NotFoundException -> 0x00b8 }
        r2 = r2.getResourceName(r3);	 Catch:{ NotFoundException -> 0x00b8 }
    L_0x0067:
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
            ...
            if (clientWidth < itemInfo.position) {
                ...
                while (i2 <= itemInfo.position && i4 < this.mItems.size()) {
                    ...
                    while (i6 < itemInfo3.position) {
                        pageWidth = (this.mAdapter.getPageWidth(i6) + f) + f3;
                        i6++;
                        f3 = pageWidth;
                    }
                    itemInfo3.offset = f3;
                ...
                while (i2 >= itemInfo.position && i4 >= 0) {
                    ...
                    i6 = i5;
                    while (i6 > itemInfo3.position) {
                        pageWidth = f3 - (this.mAdapter.getPageWidth(i6) + f);
                        i6--;
                        f3 = pageWidth;
                    }
                    f3 -= itemInfo3.widthFactor + f;
        ...
        for (i3 = i + 1; i3 < size; i3++) {
            ...
            f4 = f2;
            while (i2 < itemInfo3.position) {
                f4 = (this.mAdapter.getPageWidth(i2) + f) + f4;
                i2++;
            }
