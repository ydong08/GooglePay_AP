    ...
    public interface OnOffsetChangedListener {
        ...
        void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                android.support.design.widget.CollapsingToolbarLayout.LayoutParams layoutParams = (android.support.design.widget.CollapsingToolbarLayout.LayoutParams) childAt.getLayoutParams();
                ViewOffsetHelper viewOffsetHelper = CollapsingToolbarLayout.getViewOffsetHelper(childAt);
                switch (layoutParams.mCollapseMode) {
                    case 1:
                        viewOffsetHelper.setTopAndBottomOffset(MathUtils.constrain(-i, 0, this.this$0.getMaxOffsetForPinChild(childAt)));
                        break;
                    case 2:
            ...
            this.this$0.mCollapsingTextHelper.setExpansionFraction(((float) Math.abs(i)) / ((float) ((this.this$0.getHeight() - ViewCompat.getMinimumHeight(this.this$0)) - systemWindowInsetTop)));
        }
    }
