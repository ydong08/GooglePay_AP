...
public class UnderlinePageIndicator extends View implements OnPageChangeListener {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mViewPager != null) {
            ...
            float f2 = f + width;
            canvas.drawRect(f, (float) getPaddingTop(), f2, (float) (getHeight() - getPaddingBottom()), this.mPaint);
        }
    }
