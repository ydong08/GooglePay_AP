...
public class zza implements Creator<GoogleSignInAccount> {
    static void zza(GoogleSignInAccount googleSignInAccount, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 8, googleSignInAccount.zzaed());
        zzb.zza(parcel, 9, googleSignInAccount.zzaee(), false);
        zzb.zzc(parcel, 10, googleSignInAccount.ek, false);
    ...
    public GoogleSignInAccount zzaw(Parcel parcel) {
        ...
        while (parcel.dataPosition() < zzec) {
            ...
            switch (com.google.android.gms.common.internal.safeparcel.zza.zzjb(zzeb)) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    uri = (Uri) com.google.android.gms.common.internal.safeparcel.zza.zza(parcel, zzeb, Uri.CREATOR);
                    break;
                case 7:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    list = com.google.android.gms.common.internal.safeparcel.zza.zzc(parcel, zzeb, Scope.CREATOR);
                    break;
                case 11:
                    str7 = com.google.android.gms.common.internal.safeparcel.zza.zzq(parcel, zzeb);
                    break;
                case 12:
                    str8 = com.google.android.gms.common.internal.safeparcel.zza.zzq(parcel, zzeb);
                    break;
                default:
    ...
    public GoogleSignInAccount[] zzdc(int i) {
