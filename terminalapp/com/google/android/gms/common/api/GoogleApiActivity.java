...
public class GoogleApiActivity extends Activity implements OnCancelListener {
    ...
    private void zza(int i, zzra com_google_android_gms_internal_zzra) {
        switch (i) {
            case -1:
                com_google_android_gms_internal_zzra.zzash();
                return;
            case 0:
                com_google_android_gms_internal_zzra.zza(new ConnectionResult(13, null), getIntent().getIntExtra("failing_client_id", -1));
                return;
            default:
                return;
        }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            this.CU = bundle.getInt("resolution");
        }
        if (this.CU != 1) {
            zzarx();
        }
    ...
    protected void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.CU);
