...
public class AccessibilityDelegateCompat {
    ...
    static class AccessibilityDelegateIcsImpl extends AccessibilityDelegateImpl {
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatIcs.newAccessibilityDelegateBridge(new AccessibilityDelegateBridge(this, accessibilityDelegateCompat));
        }
    ...
    static class AccessibilityDelegateJellyBeanImpl extends AccessibilityDelegateIcsImpl {
        ...
        public Object newAccessiblityDelegateBridge(AccessibilityDelegateCompat accessibilityDelegateCompat) {
            return AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new AccessibilityDelegateBridgeJellyBean(this, accessibilityDelegateCompat));
        }
