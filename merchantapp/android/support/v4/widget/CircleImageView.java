...
class CircleImageView extends ImageView {
    ...
    class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int i) {
            this.mRadialGradient = new RadialGradient((float) (i / 2), (float) (i / 2), (float) CircleImageView.this.mShadowRadius, new int[]{1023410176, 0}, null, TileMode.CLAMP);
    ...
    CircleImageView(Context context, int i) {
        ...
        if (elevationSupported()) {
            ...
            shapeDrawable.getPaint().setShadowLayer((float) this.mShadowRadius, (float) i3, (float) i2, 503316480);
