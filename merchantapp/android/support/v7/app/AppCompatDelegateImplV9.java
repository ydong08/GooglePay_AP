    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mAppCompatCallback != null) {
                ...
                ActionMode actionMode2 = AppCompatDelegateImplV9.this.mActionMode;
            }
    ...
    ActionMode startSupportActionModeFromWindow(ActionMode.Callback callback) {
        ...
        if (!(this.mAppCompatCallback == null || isDestroyed())) {
            ...
            if (onWindowStartingSupportActionMode == null) {
                ...
                if (this.mActionModeView != null) {
                    ...
                    standaloneActionMode = new StandaloneActionMode(context, actionBarContextView, callback, z);
        ...
        if (onWindowStartingSupportActionMode == null) {
            ...
            if (this.mActionModeView != null) {
                ...
                standaloneActionMode = new StandaloneActionMode(context2, actionBarContextView2, callback, z);
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    this.mActionMode = null;
                } else {
                    standaloneActionMode.invalidate();
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        ViewCompat.setAlpha(this.mActionModeView, 0.0f);
                        this.mFadeAnim = ViewCompat.animate(this.mActionModeView).alpha(1.0f);
                        this.mFadeAnim.setListener(/* anonymous class already generated */);
                    }
                    if (this.mActionModePopup != null) {
                        this.mWindow.getDecorView().post(this.mShowActionModePopup);
                    }
