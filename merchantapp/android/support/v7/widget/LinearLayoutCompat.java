...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void measureVertical(int i, int i2) {
        ...
        i5 = (16777215 & resolveSizeAndState) - this.mTotalLength;
        int i17;
            ...
            while (i11 < virtualChildCount) {
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        f4 = f3;
                        i12 = i15;
                        i15 = ViewUtils.combineMeasuredStates(i16, ViewCompat.getMeasuredState(virtualChildAt3) & -256);
                        f5 = f4;
                    } else {
                        f5 = f3;
                        i12 = i15;
    ...
    void measureHorizontal(int i, int i2) {
        ...
        i4 = (16777215 & resolveSizeAndState) - this.mTotalLength;
        int i16;
