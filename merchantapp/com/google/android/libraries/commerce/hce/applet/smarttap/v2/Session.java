...
public class Session {
    ...
    public NdefRecord composeNdef(short s) {
        r0 = new byte[3][];
        r0[1] = new byte[]{this.sequenceNumber};
        r0[2] = new byte[]{this.status.value()};
        return NdefRecords.compose(SmartTap2Values.SESSION_NDEF_TYPE, Bytes.concat(r0), s);
    }
}
