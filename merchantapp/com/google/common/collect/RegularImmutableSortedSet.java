...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E> {
    ...
    ImmutableSortedSet<E> createDescendingSet() {
        Comparator reverse = Ordering.from(this.comparator).reverse();
        if (isEmpty()) {
            return ImmutableSortedSet.emptySet(reverse);
        }
        return new RegularImmutableSortedSet(this.elements.reverse(), reverse);
    }
}
