...
abstract class C$AutoValue_MerchantValuable extends MerchantValuable {
    ...
    C$AutoValue_MerchantValuable(Type type, byte[] bArr, byte[] bArr2, Format format, byte[] bArr3, Format format2, byte[] bArr4, Issuer issuer, Format format3, byte[] bArr5, Format format4, byte[] bArr6, Format format5, byte[] bArr7, Format format6, byte[] bArr8, Format format7, String str) {
        if (type == null) {
    ...
    L_0x0004:
        return r1;
    L_0x0005:
        r0 = r5 instanceof com.google.commerce.tapandpay.merchantapp.smarttap.v2.MerchantValuable;
        if (r0 == 0) goto L_0x019f;
    L_0x0009:
        r5 = (com.google.commerce.tapandpay.merchantapp.smarttap.v2.MerchantValuable) r5;
        r0 = r4.type;
        r3 = r5.type();
        r0 = r0.equals(r3);
    ...
    L_0x0017:
        r3 = r4.serviceId;
        r0 = r5 instanceof com.google.commerce.tapandpay.merchantapp.smarttap.v2.C$AutoValue_MerchantValuable;
        if (r0 == 0) goto L_0x00ff;
    L_0x001d:
        r0 = r5;
        r0 = (com.google.commerce.tapandpay.merchantapp.smarttap.v2.C$AutoValue_MerchantValuable) r0;
        r0 = r0.serviceId;
    L_0x0022:
    ...
    L_0x019f:
        ...
        goto L_0x0004;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.commerce.tapandpay.merchantapp.smarttap.v2.$AutoValue_MerchantValuable.equals(java.lang.Object):boolean");
    }
