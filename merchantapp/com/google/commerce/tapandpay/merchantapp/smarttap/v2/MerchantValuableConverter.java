...
import com.google.commerce.tapandpay.merchantapp.smarttap.v2.MerchantValuable.Builder;
...
public class MerchantValuableConverter implements ServiceObjectConverter {
    ...
    public List<ServiceObject> convert(NdefRecord ndefRecord, short s) throws SmartTapV2Exception {
        ...
        while (i < length) {
            ...
            if (Arrays.equals(type, SmartTap2Values.getServiceIdNdefType(s))) {
                ...
                if (SUPPORTED_SERVICE_TYPES.contains(type2)) {
                    ...
                    if (type2 == null) {
                        String str2 = "0x";
                        valueOf = String.valueOf(Hex.encodeUpper(type));
                        valueOf = valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2);
                    } else {
                        valueOf = type2.toString();
                    }
                    objArr[0] = valueOf;
        ...
        if (arrayList.isEmpty()) {
            ...
            for (NdefRecord ndefRecord32 : arrayList) {
                Builder builder = MerchantValuable.builder();
                if (s == (short) 0) {
                    if (bArr != null) {
